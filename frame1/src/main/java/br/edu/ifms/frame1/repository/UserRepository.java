...
public class UserRepository {
    ...
    public List<User> findAll() {
        ...
        users.add(new User(UUID.randomUUID(), "Caio", "caio.silva@email.com"));
        users.add(new User(UUID.randomUUID(), "Gabriel", "gabriel.oliveira@email.com"));
        users.add(new User(UUID.randomUUID(), "Eduardo Pavanelli", "eduardo.pavanelli@email.com"));
        users.add(new User(UUID.randomUUID(), "Testado", "test@email.com"));
